...
/**
 * 
 * @ClassName: PC_SignWriteNoCode   
 * @Description: 模拟PC端手写不验证签署，将请求结果放在.html文件中进行请求，就能显示当前签署方式的页面。
 * @date: 2017年6月7日 上午11:06:53   
 *
 */
public class PC_SignWriteNoCode {
	...
	public static void main(String[] args) throws Exception {
		...
		map.put("user_code", "需用户修改");//签署人的user_code
		map.put("sign_type", "WRITTEN");//手写不验证签署
