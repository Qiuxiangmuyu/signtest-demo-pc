...
public class DownloadPdf {
	...
	public static void main(String[] args) throws Exception {
	    ...
	    map.put("no", "9eb1882485864cd68b93adb3f5836bcc");//已存在的合同编号
	    ...
	    FileOutputStream fileOutputStream = new FileOutputStream("C:\\Users\\zqsign\\Desktop\\2.pdf");//存储路径，例：F://test//1.pdf
	    IOUtils.write(response_str, fileOutputStream);
	    System.out.println("当前文件流已转成PDF文件放在桌面");
