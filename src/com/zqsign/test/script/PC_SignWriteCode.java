...
/**
 * 
 * @ClassName: PC_SignWriteCode   
 * @Description: 模拟PC端手写验证签署，将请求结果放在.html文件中进行请求，就能显示当前签署方式的页面。
 * @date: 2017年6月7日 上午11:06:44   
 *
 */
public class PC_SignWriteCode {
	...
	public static void main(String[] args) throws Exception {
		...
		map.put("sign_type", "WRITTENCODE");//手写验证签署
